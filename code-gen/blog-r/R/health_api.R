...
#' @section Methods:
#' \describe{
#' \strong{ CheckHealthHealthGet } \emph{ Check Health }
#'
#' \itemize{
...
HealthApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' @return AnyType
    #' @export
    CheckHealthHealthGet = function(data_file = NULL, ...) {
      local_var_response <- self$CheckHealthHealthGetWithHttpInfo(data_file = data_file, ...)
    ...
    #' @export
    CheckHealthHealthGetWithHttpInfo = function(data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
